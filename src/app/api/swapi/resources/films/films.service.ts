...
export class FilmsService {
  ...
  getItem(id: Signal<string>, options?: RetryableHttpResourceMethodOptions): SwapiServiceResult<Film | undefined> {
    return this.service.getItem(id, options)
  }

  getItems(ids: Signal<string[]>, options?: RetryableHttpResourceMethodOptions): SwapiServiceResult<Film[]> {
